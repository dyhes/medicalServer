...
const QMetaObject MTcpServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_MTcpServer.data,
      qt_meta_data_MTcpServer,  qt_static_metacall, nullptr, nullptr}
};
...
void *MTcpServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MTcpServer.stringdata0))
        return static_cast<void*>(const_cast< MTcpServer*>(this));
