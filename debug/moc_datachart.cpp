...
const QMetaObject DataChart::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DataChart.data,
...
void *DataChart::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DataChart.stringdata0))
        return static_cast<void*>(const_cast< DataChart*>(this));
