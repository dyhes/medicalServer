...
QT_MOC_LITERAL(1, 8, 13), // "sendDataFrame"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11), // "MDataFrame*"
QT_MOC_LITERAL(4, 35, 9), // "dataFrame"
QT_MOC_LITERAL(5, 45, 9), // "sendError"
QT_MOC_LITERAL(6, 55, 28), // "QAbstractSocket::SocketError"
QT_MOC_LITERAL(7, 84, 11), // "socketError"
QT_MOC_LITERAL(8, 96, 9) // "parseData"

    },
    "MThread\0sendDataFrame\0\0MDataFrame*\0"
    "dataFrame\0sendError\0QAbstractSocket::SocketError\0"
    "socketError\0parseData"
};
...
void MThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendDataFrame((*reinterpret_cast< MDataFrame*(*)>(_a[1]))); break;
        case 1: _t->sendError((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        ...
        {
            typedef void (MThread::*_t)(MDataFrame * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MThread::sendDataFrame)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MThread::staticMetaObject = {
...
void *MThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MThread.stringdata0))
        return static_cast<void*>(const_cast< MThread*>(this));
...
// SIGNAL 0
void MThread::sendDataFrame(MDataFrame * _t1)
{
